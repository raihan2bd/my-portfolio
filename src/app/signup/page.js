  ...
  return (
    <section className="pt-6 flex flex-col justify-center items-center min-h-[500px]">
      <form onSubmit={formSubmitHandler} className="flex flex-col gap-3 p-4 w-[598px] max-w-[100%] mx-auto overflow-hidden border rounded-lg">
        ...
        <button className="bg-sky-500 px-4 py-2 w-fit ms-auto mt-2" disabled={loading} type="submit">Signup</button>
        <p className="text-center mt-2">If you already have an account please <Link className="text-sky-500" href="/login">Login</Link></p>
      </form>
    </section>
  )
